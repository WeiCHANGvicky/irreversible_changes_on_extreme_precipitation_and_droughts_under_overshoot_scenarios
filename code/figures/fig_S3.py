...
def draw_scatter_subplot(ax, gmst_ts, pr_ts, target_temp, panel_label, region_title, ks_p1, ks_p4, inset_pos=[0.58, 0.12, 0.35, 0.32], target_years=None):
    ...
    ax.set_ylabel('Annal minimum SPI-12', fontsize=10, labelpad=2)
    ax.set_title(f'{panel_label}', fontsize=10, fontweight='bold', loc='left')
...
im_a = draw_map_subplot(ax_a, data_126['map_data'], data_126['map_agree'], '(a) Annual minimum SPI-12', 'SSP1-2.6')
im_b = draw_map_subplot(ax_b, data_534['map_data'], data_534['map_agree'], '(b) Annual minimum SPI-12', 'SSP5-3.4-OS')
...
plt.savefig('FigureS3.pdf', dpi=800, bbox_inches='tight')
plt.savefig('FigureS3.png', dpi=800, bbox_inches='tight')
plt.show()